...
contains ~17 Mb of sequence duplications and missassemblies that were
...
spurious splice variants. Figure~\ref{bitscore} shows that the median of
bitscore/length ratios of isoforms is lower than that of genes, suggesting
poorer alignments of isoforms to mouse protein sequences.
