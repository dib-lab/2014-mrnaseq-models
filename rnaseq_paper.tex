...
These novel splice sites include both canonical splie and non-canonical splice sites.
Approximately, $46\%-75\%$ of canonical splice sites are supported by ESTs.
Novel splice junctions have different read coverage suggesting that both high-
and low-expressed isoforms are not annotated.
...
of annotated exons and a small fraction of isoforms contain exons from intergenic or
intronic region.
...
a read aligner that can align reads across putative exon junctions, to reconstruct a full-length transcripts.
...
isoforms in lincRNA loci in any of the three different cell types\cite{Guttman:2010io}.

The genome-guided method has been useful in both detecting splice junctions and isoforms.
...
It has also been shown that Trinity detects unique sets of splice junctions when compared to annotated
junctions and junctions detected by Cufflinks and Scripture.
This suggests that \emph{de novo} assembly approach is capabale of increasing sensitivity of detecting
alternative isoforms of genome-guided methods.
